...
| C. Predicted harvest recovery | Validated experimental prototype | Current survival minus age-band historical remaining loss; 5 historical cycles, 25 building outcomes, and 122 balanced as-of snapshots; nested whole-cycle MAE 1.40 points, cycle-balanced MAE 1.50 points, and R² 0.222. Robust Huber is the best learned challenger, but it fails the full rolling-origin and 95% classification gate, so the transparent baseline remains operational. |
