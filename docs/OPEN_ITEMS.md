...
|---|---|---|---|---|---|---|
| OPEN-001 | Before farm-policy claim | Approve or revise the four risk checks—weight gap, population loss, daily mortality, and combined environmental conditions—and their score bands. | The revised score is simpler and actionable, but environmental severity distances still need calibration. | Version `risk-rules-0.4.0-tropical-bands` is traceable and provisional; missing evidence is not treated as safe. | Doc Raymond / farm operations | Open |
...
| OPEN-010 | Before farm-policy claim | Confirm the supplied tropical temperature/humidity bands, sensor position, and housing context; confirm whether Day 35 bands carry after Day 35. | The ranges now drive formal environmental risk points. | The supplied bands are implemented and editable, with full calculation trace. | Doc Raymond / farm operations | Open |
| OPEN-011 | Before farm-policy claim | Approve the distance-outside-band severity rules: temperature 0/1/2°C and humidity 0/5/10 points for 0/1/2/3 scoring. | These determine environmental severity. | Exact evidence and rule are shown; values remain labeled provisional. | Doc Raymond / farm operations | Open |
