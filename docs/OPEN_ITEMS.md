...
| Primary liveweight goal | At least 1.8 kg on Day 35; birds may continue growing after Day 35 |
...
| Weight checkpoints | Day 7: 170 g; Day 14: 380 g; Day 21: 800 g; Day 28: 1,200 g; Day 35: 1,800 g |
...
|---|---|---|---|---|---|---|
| OPEN-001 | Before farm-policy claim | Approve or revise the four risk checks—weight gap, population loss, daily mortality, and combined environmental conditions—and their score bands. | The revised score is simpler and actionable, but the environmental limits are not yet calibrated. | Version `risk-rules-0.3.0-doc-validation` is traceable and provisional; missing evidence is not treated as safe. | Doc Raymond / farm operations | Open |
| OPEN-002 | Before farm-approved recommendations | Review Doc Raymond's trigger/action mappings, response times, possible causes, responsible people, and escalation rules. | The new playbook follows the Farmer Validation Workbook but still needs formal sign-off. | Guidance is deterministic, editable, and clearly framed as inspection—not diagnosis or treatment. | Doc Raymond | Open |
...
| OPEN-010 | Before farm-policy claim | Approve age-specific absolute temperature ranges, sensor position, and housing context. | The Farmer Validation Workbook's old temperature targets appear too low for the Philippine setting. | Absolute temperature remains a provisional operating alert; unapproved values do not add formal risk points. | Doc Raymond / farm operations | Open |
| OPEN-011 | Before farm-policy claim | Calibrate daily temperature-range and humidity thresholds. | The current 2/3/5°C rule places most recorded days above 5°C, so it may produce excessive critical environmental scores. | Exact environmental score evidence is shown; thresholds are editable and labeled provisional. | Doc Raymond / farm operations | Open |
| OPEN-012 | Before adding feed to the score | Confirm Daily FI/bird units and age-based warning/critical gap definitions. | Some feed-per-bird values are implausibly large across cycles, indicating inconsistent units or formulas. | Feed is shown as a supporting alert only; it does not add risk points. | Doc Raymond / data owner | Open |
