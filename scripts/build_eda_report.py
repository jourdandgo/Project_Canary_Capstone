    ...
    "manifest": {
        ...
        "blocks": [
            ...
            {"id": "recovery-chart", "type": "chart", "chartId": "day14-recovery"},
            {
                "id": "day35-finding",
                "type": "markdown",
                "body": "## Cycle conditions explain much of the Day 35 weight relationship\n\nAcross all 19 pairs, Day 14 and Day 35 measured weights move together. However, the relationship largely disappears after removing each cycle's average. This means the dataset supports a broad cycle-level statement—better-performing cycles tend to be heavier at both ages—but not a strong building-level rule that a 100 g Day 14 difference will reliably persist to Day 35.\n\nAll 19 recorded Day 35 weights were below 2.0 kg, while 10 of 17 trusted final-harvest average weights were at least 2.0 kg. Day 35 should therefore remain a management milestone, not be confused with actual final-harvest weight.",
                "sourceId": "farm-data",
            },
            ...
            {"id": "association-detail", "type": "table", "tableId": "association-table"},
            {
                "id": "practicality",
                "type": "markdown",
                "body": "## Canary is practical for triage and recovery estimation—with clear limits\n\n**Rules-based risk:** practical because it is deterministic, inspectable and actionable. It answers which building deserves attention and why. It should not be called the probability of missing a target, and current thresholds should remain provisional.\n\n**Recovery forecast:** credible enough for a capstone prototype. The Ridge model improves average error over the historical-mean baseline, and the exact Day 14 held-out test averages 1.36 percentage points of error. Removing weight features barely changes Day 14 error and slightly improves overall error, so current recovery predictive power mostly comes from survival, mortality and other signals—not bodyweight alone.\n\n**Final-weight forecast:** not yet credible as a personalized answer to “if today is Day X and weight is Y, where will this building finish?” The selected method is the farm historical mean. Its 0.093 kg average error looks reasonable, but it ignores the current building weight and identifies the correct side of 2.0 kg only 32.2% of the time.",
            },
